// g++ 23_tomog-adv-filter.cpp -std=c++17 -lraylib -O3
...
struct SolarParticle{
    // Segment fit to linear artefacts in solar tomography
    seg3d   segment;
    seg3d   cross1;
    seg3d   cross2;
    Vector3 center;
    ...
    // FIXME: GET QUANTIZED ADDRESSES ALONG THE SEGMENT
};

vector<SolarParticle> fit_artefacts_in_tomog( const vvvf& data ){
    // Attempt to fit line segments to the artefacts in the solar tomography
    // FIXME, START HERE: SEED SPACE, ASCEND GRADIENT, CULL POOR FITS, RESAMPLE GOOD FITS
}
