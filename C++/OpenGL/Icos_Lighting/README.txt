...
13 hours
	* Refactored all old code , Separate source files for objects
		- Added the Eigen library with OpenGL support , 
		  I know this is way overkill for math but it meets two purposes: 1. To reuse MS thesis code , 2. To be useful in ongoing work
		- Added some previous work in math / geo , separate libraries
	* Added and tuned a second light source
	* Refactored cylinders for efficiency and to remove hacked outlines (see "OGL_utils")
	* "Particle effects"! - I cheesed this with a vector of objects and would be very interested in learning *actual* particle effects!
