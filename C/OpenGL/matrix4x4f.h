...
void   identity_mtx44f( float mat[] ); // ----------------------- Identity 4x4 matrix
void   identity_mtx33f( float mat[] ); // ----------------------- Identity 3x3 matrix
float* make_identity_mtx44f( void ); // ------------------------- Identity 3x3 matrix
void   copy_mtx44f( float mat[], /*<<*/ const float m[] ); // --- Copy 4x4 matrix
void   mult_mtx44f( float mat[], float m[] ); // ---------------- Right multiply 4x4 matrix
