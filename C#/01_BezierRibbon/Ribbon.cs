...
/// <summary>
/// Things that have `Tri` meshes
/// </summary>
public interface IMeshHaver {
...
/// </summary>
public class Ribbon : IMeshHaver {
...
public class RNode : IMeshHaver {
    ...
    public List<Tri> GetTotalMesh(){  return mesh;  }
